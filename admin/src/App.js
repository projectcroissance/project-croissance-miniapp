...
const NAV_ITEMS = [
  ...
  { id: 'submissions', label: 'Submissions', icon: 'M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2 M9 12l2 2 4-4' },
  { id: 'tasks',       label: 'Tasks',       icon: 'M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2 M12 11h4 M12 15h4 M8 11h.01 M8 15h.01' },
  { id: 'members',     label: 'Members',     icon: 'M17 21v-2a4 4 0 00-4-4H5a4 4 0 00-4 4v2 M9 7a4 4 0 100 8 4 4 0 000-8z M23 21v-2a4 4 0 00-3-3.87 M16 3.13a4 4 0 010 7.75' },
  { id: 'leaderboard', label: 'Leaderboard', icon: 'M22 12h-4l-3 9L9 3l-3 9H2' },
];

const PAGE_TITLES = {
  dashboard: 'Dashboard', submissions: 'Submission Reviews',
  tasks: 'Task Management', members: 'Members', leaderboard: 'Leaderboard',
};

// ─── Login Gate ───
function LoginGate({ onLogin, checking }) {
    ...
    <div style={{
      ...
      <div style={{
        ...
        <p style={{ textAlign: 'center', marginTop: 16, fontSize: 12 }}>
          Password verified securely server-side. Nothing is stored in your browser.
        </p>
      </div>
    </div>
  );
...
export default function App() {
  ...
  if (!authed) return <LoginGate onLogin={login} checking={checking} />;
